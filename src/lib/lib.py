...
class Reserved:
    ...
    def __init__(self):
      self.words = {
        ...
        'len': Token(TYPE.FUN, None),
        'let': Token(Type.LET, 'let'),
        'lim': Token(Type.FUN, None),
        'ln': Token(Type.FUN, None),
        'log': Token(Type.FUN, None),
        'mod': Token(Type.MOD, '%'),
        'N': Token(Type.N, 'N'),
        ...
        'print': Token(Type.FUN, None),
        'prod': Token(Type.FUN, None),
        'Q': Token(Type.Q, 'Q'),
